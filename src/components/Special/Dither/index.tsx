...
void main() {
  ...
  vec3 blueBase = vec3(0.0, 0.13, 0.96);
  vec3 col = mix(blueBase, waveColor, f);
...
class RetroEffectImpl extends Effect {
  public uniforms: Map<string, THREE.Uniform<number | THREE.Vector2>>;
  constructor() {
  ...
  return (
    <div style={{ width: '100%', height: '100%', pointerEvents: 'auto' }}>
      <Canvas
        ...
        dpr={1}
        gl={{ antialias: true, preserveDrawingBuffer: true, alpha: true, failIfMajorPerformanceCaveat: false }}
